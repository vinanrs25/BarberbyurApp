...
public class EditItemDialog extends javax.swing.JDialog {
    ...
    public EditItemDialog(
        ...
        if (tipe.equalsIgnoreCase("service")
                || tipe.equalsIgnoreCase("Layanan")
                || tipe.equalsIgnoreCase("Layanan (Jasa)")) {

            jComboBoxTipe.setSelectedItem("Layanan (Jasa)");

        } else {

            jComboBoxTipe.setSelectedItem("Produk (Barang)");
        }
        ...
        if (status.equals("aktif")) {
            ...
            jComboBoxStatus.setSelectedItem("Aktif");

        } else {

            jComboBoxStatus.setSelectedItem("Nonaktif");
        }
