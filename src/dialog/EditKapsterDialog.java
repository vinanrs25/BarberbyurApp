 ...
 * @author rhmnsae
 */
public class EditKapsterDialog extends javax.swing.JDialog {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(EditKapsterDialog.class.getName());
    
    private int idKapster;
    /**
     * Creates new form TambahPelangganDialog
     */
    public EditKapsterDialog(
        ...
        namaField1.setText(no_hp);
        spealisasiField.setText(spesialisasi);
        komisiKapsterField.setText(String.valueOf(komisi));

        komisiOwnerField.setEditable(false);
        komisiOwnerField.setFocusable(false);
        komisiOwnerField.setText(String.valueOf(100 - komisi));

        jComboBoxStatus.setSelectedItem(status);

        // auto hitung owner
        komisiKapsterField.getDocument().addDocumentListener(
    ...
    private void initComponents() {
        ...
        labelJudul.setText("Edit Kapster");
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        """;
            ...
            ps.setString(5, statusUI);
            ps.setInt(6, idKapster);

            ps.executeUpdate();

            JOptionPane.showMessageDialog(
                    this,
                    "Data kapster berhasil diupdate!"
            );
